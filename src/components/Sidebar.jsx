...
export function Sidebar({
  ...
  const sidebarContent = (
    <>
          ...
          <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-0.5">
            {searchQuery && (
              <button
                ...
                className="text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200 cursor-pointer p-0.5 rounded"
              >
                <X className="w-3 h-3" />
              </button>
            )}
            <button
              ...
              className="text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200 cursor-pointer p-1 rounded hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
            >
      ...
      {/* Sidebar Footer */}
      <div className="p-3 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/40 shrink-0 flex flex-col gap-1 select-none">
        <Button
          type="button"
          variant="ghost"
          onClick={onOpenCheatsheet}
          className="w-full justify-start gap-2 px-3 h-8 text-xs font-medium text-zinc-650 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer transition-colors rounded-md"
        >
